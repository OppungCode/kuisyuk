...
/// cleanup: only here for compatibility reasons with old code, remove it in future v2.2.6
const defaultQuizLanguage = '';
...
const getSupportedLanguageListUrl = '${baseUrl}get_system_language_list';
...
const purchaseIAP = '${baseUrl}set_user_in_app';
